	...
	class ANELM_AOS {
		...
		public function enqueue_aos_assets() {
			wp_enqueue_style(
				...
				ANELM_URL . 'assets/css/vendor/aos.css',
				array(),
				ANELM_VERSION
			);
			...
			wp_enqueue_script(
				'animate-elementor-aos',
				ANELM_URL . 'assets/js/vendor/aos.js',
				array(),
				ANELM_VERSION,
				true
			);
		...
		public function add_aos_controls( $element, $section_id, $args ) {
			...
			$element->add_control(
				'animate_elementor_aos_heading',
				array(
					'type'      => \Elementor\Controls_Manager::HEADING,
					'label'     => __( 'Scroll Animation', 'animate-elementor' ),
					'separator' => 'before',
				)
			);
			...
			$element->add_control(
				...
				array(
					...
					'return_value' => 'yes',
					'default'      => '',
					'description'  => __( 'Enable this to apply the AOS (Animate On Scroll) effect to the widget when it is scrolled into view.', 'animate-elementor' ),
				)
			);
			...
			$element->add_control(
				...
				array(
					...
					'description' => __( 'Choose the animation type that will trigger when the widget enters the viewport.', 'animate-elementor' ),
				)
			);
			...
			$element->add_control(
				...
				array(
					...
					'default'   => 120,
					'condition' => array( 'animate_elementor_aos_enable' => 'yes' ),
					'description' => __( 'Set the offset in pixels from the bottom of the screen where the animation will start.', 'animate-elementor' ),
				)
			);
			...
			$element->add_control(
				...
				array(
					...
					'default'   => 0,
					'condition' => array( 'animate_elementor_aos_enable' => 'yes' ),
					'description' => __( 'Set the delay before the animation starts after the element is triggered.', 'animate-elementor' ),
				)
			);
			...
			$element->add_control(
				...
				array(
					...
					'default'   => 400,
					'condition' => array( 'animate_elementor_aos_enable' => 'yes' ),
					'description' => __( 'Set the duration of the animation in milliseconds.', 'animate-elementor' ),
				)
			);
			...
			$element->add_control(
				...
				array(
					...
					'default'   => 'ease',
					'condition' => array( 'animate_elementor_aos_enable' => 'yes' ),
					'description' => __( 'Choose the easing type for the animation curve (e.g., linear, ease-in, etc.).', 'animate-elementor' ),
				)
			);
			...
			$element->add_control(
				...
				array(
					...
					'default'      => '',
					'condition'    => array( 'animate_elementor_aos_enable' => 'yes' ),
					'description'  => __( 'Enable this option to animate the element only the first time it enters the viewport.', 'animate-elementor' ),
				)
			);
			...
			$element->add_control(
				...
				array(
					...
					'default'      => '',
					'condition'    => array( 'animate_elementor_aos_enable' => 'yes' ),
					'description'  => __( 'Enable this option to mirror the animation when the user scrolls back up to the element.', 'animate-elementor' ),
				)
			);
			...
			$element->add_control(
				...
				array(
					...
					'default'   => 'top-bottom',
					'condition' => array( 'animate_elementor_aos_enable' => 'yes' ),
					'description' => __( 'Choose where to anchor the element on the viewport. This determines how it appears relative to the scroll position.', 'animate-elementor' ),
				)
			);
			...
			$element->add_control(
				...
				array(
					...
					'condition'   => array( 'animate_elementor_aos_enable' => 'yes' ),
					'description' => __( 'Select devices where the AOS effect should be disabled (e.g., tablet, mobile).', 'animate-elementor' ),
				)
			);
