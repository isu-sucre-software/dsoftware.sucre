...
if ( ! class_exists( 'ANELM_install' ) ) :
    ...
    class ANELM_install {
        ...
        public static function plugin_action_links( $links ) {
            $action_links = array(
                'hire_us' => sprintf(
                    '<a href="%s" aria-label="%s" style="color: #93003f;font-weight:700;">%s</a>',
                    esc_url( 'https://wordpress.org/support/users/spiderwares/' ),
                ...
                'request_feature' => sprintf(
                    '<a href="%s" aria-label="%s" style="color: #93003f;font-weight:700;">%s</a>',
                    esc_url( 'https://wordpress.org/support/users/spiderwares/' ),
                    esc_attr__( 'Request a feature', 'animate-elementor' ),
                    esc_html__( 'Request a feature', 'animate-elementor' )
                ),
            );
